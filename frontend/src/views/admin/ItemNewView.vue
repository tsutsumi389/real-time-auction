      ...
      <div class="mb-6">
        ...
        <div class="relative rounded-md shadow-sm">
          ...
          <input
            ...
            type="number"
            min="1"
            class="block w-full pl-8 pr-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            placeholder="0"
          />
        </div>
